...
<div class="container header-container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="title card-header">Вход</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="form-label col-md-4 col-form-label text-md-right">Введите E-Mail </label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="form-label col-md-4 col-form-label text-md-right">Введите пароль</label>
